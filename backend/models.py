...
class User(db.Model):
    ...
    # Chat features (ADDED - nothing removed)
...
class GroupMember(db.Model):
    """Group membership (ADDED - new table)"""
...
class TypingStatus(db.Model):
    """Typing indicators (ADDED - new table)"""
